...
class StoryBrain {
  ...
  String getStory() {
    return StoryBrain()._storyData[_storyNumber].storyTitle;
  }

  String getChoice1() {
    return StoryBrain()._storyData[_storyNumber].choice1;
  }

  String getChoice2() {
    return StoryBrain()._storyData[_storyNumber].choice2;
  }
